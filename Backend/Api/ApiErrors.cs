...
public static class ApiErrorCatalog
{
    private static readonly IReadOnlyDictionary<string, ApiErrorDefinition> Definitions = new Dictionary<string, ApiErrorDefinition>(StringComparer.Ordinal)
    {
        ...
        ["xp.settings.voiceEligibilityRequired"] = new("xp.settings.voiceEligibilityRequired", "Voice XP eligibility settings are required.", StatusCodes.Status400BadRequest),
        ["xp.settings.voiceMinimumParticipants"] = new("xp.settings.voiceMinimumParticipants", "MinimumHumanParticipants must be between 1 and 99.", StatusCodes.Status400BadRequest),
        ["xp.settings.voiceParticipantCountingMode"] = new("xp.settings.voiceParticipantCountingMode", "ParticipantCountingMode must be a known value.", StatusCodes.Status400BadRequest),
        ...
        ["xp.settings.levelRoles"] = new("xp.settings.levelRoles", "Level roles require unique roles, positive levels, and descriptions of at most 280 characters.", StatusCodes.Status400BadRequest),
        ...
        ["xp.import.unsupportedFormat"] = new("xp.import.unsupportedFormat", "The JSON is neither a supported MEE6 export nor a supported Rankoon export.", StatusCodes.Status400BadRequest),
        ["xp.import.guildMismatch"] = new("xp.import.guildMismatch", "The file does not contain leaderboard data for the selected Discord server.", StatusCodes.Status400BadRequest),
        ["xp.import.invalidPlayers"] = new("xp.import.invalidPlayers", "The MEE6 players export is invalid.", StatusCodes.Status400BadRequest),
        ["xp.import.invalidEntries"] = new("xp.import.invalidEntries", "The Rankoon entries export is invalid.", StatusCodes.Status400BadRequest),
        ...
        ["xpAudit.invalidSort"] = new("xpAudit.invalidSort", "The XP audit member sort is invalid.", StatusCodes.Status400BadRequest),
        ...
        , ["levelAnnouncements.settingsInvalid"] = new("levelAnnouncements.settingsInvalid", "Level-up announcement settings are invalid.", StatusCodes.Status400BadRequest)
         ...
         , ["levelAnnouncements.required"] = new("levelAnnouncements.required", "A required announcement value is missing.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.invalid"] = new("levelAnnouncements.invalid", "An announcement value is invalid.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.activeMessageRequired"] = new("levelAnnouncements.activeMessageRequired", "An enabled announcement group needs an active message.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.duplicateId"] = new("levelAnnouncements.duplicateId", "Announcement group and message IDs must be unique.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.length"] = new("levelAnnouncements.length", "The announcement message length is invalid.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.unknownToken"] = new("levelAnnouncements.unknownToken", "The announcement contains an unknown template token.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.missingContext"] = new("levelAnnouncements.missingContext", "The announcement token context is unavailable.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.invalidToken"] = new("levelAnnouncements.invalidToken", "The announcement contains an invalid template token.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.rewardTokenRequiresRewardSet"] = new("levelAnnouncements.rewardTokenRequiresRewardSet", "Reward tokens can only be used in the Rewards set.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.seasonTokenRequiresSeasonScope"] = new("levelAnnouncements.seasonTokenRequiresSeasonScope", "Season tokens can only be used in the Season scope.", StatusCodes.Status400BadRequest)
         , ["levelAnnouncements.channelInvalid"] = new("levelAnnouncements.channelInvalid", "The selected channel is invalid.", StatusCodes.Status400BadRequest)
