...
export const KNOWN_API_ERROR_KEYS = [
  ...
  'xp.settings.voicePoints', 'xp.settings.voiceTiming', 'xp.settings.voiceEligibilityRequired',
  'xp.settings.voiceMinimumParticipants', 'xp.settings.voiceParticipantCountingMode', 'xp.settings.reaction',
  ...
  'xp.settings.serverBoosterOrder', 'xp.import.unsupportedFormat', 'xp.import.guildMismatch', 'xp.import.invalidPlayers',
  'xp.import.invalidEntries', 'xp.import.noValidMembers',
