...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      }] : []),
      {
        ...
        children: [
          { path: '', redirectTo: 'overview', pathMatch: 'full' },
          { path: 'overview', loadComponent: () => import('./pages/guild-analytics/analytics-overview.component').then(c => c.AnalyticsOverviewComponent) },
          { path: 'xp', loadComponent: () => import('./pages/guild-analytics/analytics-xp.component').then(c => c.AnalyticsXpComponent) },
          { path: 'voice', loadComponent: () => import('./pages/guild-analytics/analytics-voice.component').then(c => c.AnalyticsVoiceComponent) },
          { path: 'features', loadComponent: () => import('./pages/guild-analytics/analytics-features.component').then(c => c.AnalyticsFeaturesComponent) },
          { path: 'audit', loadComponent: () => import('./pages/guild-analytics/analytics-audit.component').then(c => c.AnalyticsAuditComponent) },
        ],
      },
